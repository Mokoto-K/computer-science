...
def matchingLetters(wordA:String, wordB:String):List[(Int, Int)] = {
  ...
  var matches:List[(Int, Int)] = Nil 
  
  var x:Int = 0
  var y:Int = 0
  
  var a:Int = wordA.length()
  var b:Int = wordB.length()
      
  while x < a do 
      while y < b do 
          if wordA(x) == wordB(y) then 
              matches = (x, y) :: matches 
          y += 1 
      x += 1 
      y = 0 
...
/**
  ...
  * 
  * So we want
  * "M" -> 1000 :: "CM" -> 900 :: "D" -> 500 :: "CD" -> 400 :: "C" -> 100 :: "XC" -> 90 :: "L" -> 50 :: "XL" -> 40 :: "X" -> 10 :: "IX" -> 9 :: "V" -> 5 :: "IV" -> 4 :: "I" -> 1 :: Nil
...
def roman(i:Int):String = {
  val numerals:List[(String, Int)] = "M" -> 1000 :: "CM" -> 900 :: "D" -> 500 :: "CD" -> 400 :: "C" -> 100 :: "XC" -> 90 :: "L" -> 50 :: "XL" -> 40 :: "X" -> 10 :: "IX" -> 9 :: "V" -> 5 :: "IV" -> 4 :: "I" -> 1 :: Nil
  ...
  while remainder > 0 do
      if remainder >= numerals(x)(1) then 
          result += numerals(x)(0)
          remainder -= numerals(x)(1)
      else 
          x += 1 
  result      
}
