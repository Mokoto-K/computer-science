...
body of the code.
items = {'bun': {'val': {'milk': 0, 'gluten free': 1}, 'q': 'What type of bun 
for burger {b} - milk or gluten free? '},
         'sauce':{'val':{'tomato':0,'barbecue':0,'none':0},'q':"What sauce for 
burger {b} - tomato, barbecue or none? "},
         'patties': {'val': {'0': 0, '1': 0, '2': 3, '3': 6}, 'q': "How many {c} 
for burger {b} - 0-3? "},
         'cheese': {'val': {'0': 0, '1': 0, '2': 1, '3': 2}, 'q': "How many 
slices of {c} for Burger {b} - 0-3? "},
         'tomato': {'val': {'yes': 1, 'no': 0}, 'q': "Should Burger {b} have {c} 
- yes or no? "},
         'lettuce': {'val': {'yes': 1, 'no': 0}, 'q': "How about {c} for burger 
{b} - yes or no? "},
         'onion': {'val': {'yes': 1, 'no': 0}, 'q': "Would you like {c} on 
burger {b} - yes or no? "},
